...
##----------------------------------------------------------------
##              Importing New Horizons Data Catalogs             -
##----------------------------------------------------------------


data_path = "/Users/RachelCampo/Desktop/CUNY/Filament Research/New Horizons Data/"

##################################################################
##                    Importing Treebrick Data                   #
##################################################################

# This data came from the file path:
# /data7b/NewHorizon/TREE_STARS_AdaptaHOP_dp_SCnew_gross
AdaptaHOP_treebrick_173 = str(data_path) + "tree_bricks173"
AdaptaHOP_treebrick_270 = str(data_path) + "tree_bricks270"
AdaptaHOP_treebrick_970 = str(data_path) + "tree_bricks970"

# This data came from the file path: 
# /data7b/NewHorizon/TREE_STARS_HOP_dp_SCnew_gross
HOP_treebrick_173 = str(data_path) + "tree_brick_173"
HOP_treebrick_270 = str(data_path) + "tree_brick_270"
HOP_treebrick_970 = str(data_path) + "tree_brick_970"


##---------------------------------------------------------------
##                Set Up Classes to Read Catalogs               -
##---------------------------------------------------------------
...
class ReadTreebrick_highp:
    ...
    def read_data(self):
        ...
        for i in range(nhaloes):
            ...
            print("="*50)
            print("The Level IDS Information:")
            print(f"{level_ids}, at index {i}")
            print("="*50)

            level, host_halo, host_sub, nchild, nextsub = level_ids[0], level_ids[1], level_ids[2], level_ids[3], level_ids[4]
            print("="*50)
            print("Level Information:")
            print(f"{level}, at index {i}")
            print("Host Halo Information:")
            print(f"{host_halo}, at index {i}")
            print("Host Sub-Halo Information:")
            print(f"{host_sub}, at index {i}")
            print("NChild Information:")
            print(f"{nchild}, at index {i}")
            print("Next Sub Information:")
            print(f"{nextsub}, at index {i}")
            print("="*50)
            ...
            print("=" * 50)
            print("Passed Adding in Info in Dictionary: ", i)
            print("=" * 50)

            mass = f.read_record('f') #d for NH
            halo_dict['mass'] = mass.tolist()
            print("=" * 50)
            print("Passed Adding in Mass Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['pz'] = pz
            print("=" * 50)
            print("Passed Adding in Momentum Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['vz'] = vz
            print("=" * 50)
            print("Passed Adding in Velocity Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['Lz'] = Lz
            print("=" * 50)
            print("Passed Adding in Angular Momentum Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['c'] = c
            print("=" * 50)
            print("Passed Adding in Shape Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['et'] = et
            print("=" * 50)
            print("Passed Adding in Energy Info in Dictionary: ", i)
            print("=" * 50)

            spin = f.read_record('f')
            halo_dict['spin'] = spin.tolist()
            print("=" * 50)
            print("Passed Adding in Spin Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['cvel'] = cvel 
            print("=" * 50)
            print("Passed Adding in Virial Radius Info in Dictionary: ", i)
            print("=" * 50)
            ...
            halo_dict['r_c'] = r_c
            print("=" * 50)
            print("Passed Adding in Rho and R_c Info in Dictionary: ", i)
            print("=" * 50)
            ...
            print("=" * 50)
            print("Passed Returning the Halo Dictionary: ", i)
            print("=" * 50)
...
##----------------------------------------------------------------
##          Going to Test The Classes on Imported Data           -
##----------------------------------------------------------------

AdaptaHOP_HP_Read_173 = ReadTreebrick_highp(file_path = AdaptaHOP_treebrick_173)
# This is what prints out in the terminal when I run this line:
#
#
# ==================================================
# The Level IDS Information:
# [1, 1, 0, 44, 2854], at index 0
# ==================================================
# ==================================================
# Level Information:
# 1, at index 0
...
# 1, at index 0
# Host Sub-Halo Information:
# 0, at index 0
# NChild Information:
# 44, at index 0
# Next Sub Information:
# 2854, at index 0
# ==================================================
# ==================================================
# Passed Adding in Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Mass Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Momentum Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Velocity Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Angular Momentum Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Shape Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Energy Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Spin Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Virial Radius Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Adding in Rho and R_c Info in Dictionary:  0
# ==================================================
# ==================================================
# Passed Returning the Halo Dictionary:  0
# ==================================================
# ==================================================
# The Level IDS Information:
# [313282], at index 1
...
#   File "<stdin>", line 64, in read_data
# IndexError: list index out of range
# 
# It looks like for some reason, the problem arrises in the loop in the 
# read_data function. At the zeroth index, I seem to be getting the correct
# list of IDS information but then at the first index, I only get a list that
# has one element in it. I am not sure what is going on here?

HOP_HP_Read_173 = ReadTreebrick_highp(file_path = HOP_treebrick_173)

AdaptaHOP_LP_Read_173 = ReadTreebrick_lowp(file_path = AdaptaHOP_treebrick_173)
HOP_LP_Read_173 = ReadTreebrick_lowp(file_path = HOP_treebrick_173)

AdaptaHOP_HP_Read_970 = ReadTreebrick_highp(file_path = AdaptaHOP_treebrick_970)
...
#         self.treebricks_dict['omega_t'] = omega_t
#         self.treebricks_dict['age_univ'] = age_univ
#         self.treebricks_dict['nhost'] = nsub[0] # main structure
#         self.treebricks_dict['nsub'] = nsub[1] # sub structure
#         nhaloes = nsub[0]+nsub[1] # total number of structures
#         self.treebricks_dict['nhaloes'] = nhaloes
#         #initialize empty list to hold all halos
#         self.treebricks_dict['haloes'] = []
...
#             shape = f.read_record('f') # is this a python float for fortran float? need to check
#             shape = shape.tolist()
#             rmax,a,b,c = shape[0],shape[1],shape[2],shape[3]
#             halo_dict['rmax'] = rmax
#             #write old shapes as well
